# Generated by Django 4.2.20 on 2025-07-12 18:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Yaratilgan vaqti')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Yangilangan vaqti')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_profile', to=settings.AUTH_USER_MODEL, verbose_name='Foydalanuvchi (User)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=auth_app.models.grant_document_path, validators=[auth_app.models.validate_file_size, auth_app.models.validate_file_extension], verbose_name='Hujjat fayli')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=auth_app.models.appeal_document_path, validators=[auth_app.models.validate_file_size, auth_app.models.validate_file_extension], verbose_name='Hujjat fayli')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
